...
$date= $_POST['date'];
	...
	mysqli_query($con,"UPDATE Student SET stdNum='$stdNum', email='$email' ,password='$password', contactno='$contact', posting_date ='$date' where email='".$_GET['uid']."'");
...
<html lang="en">
  <head>
    ...
    <link href="assets/css/style-responsive.css" rel="stylesheet">
      ...
      <?php $ret=mysqli_query($con,"select * from Student a, StudentRecor b WHERE a.stdNum = b.stdNum AND   email='".$_GET['uid']."'");
