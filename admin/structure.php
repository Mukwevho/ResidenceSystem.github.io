                      ...
                      <div class="content-panel">
                          <!--<table class="table table-striped table-advance table-hover">
                              ...
                              <tbody>-->
                                  <div id="explore">
        								<div class="container">
											<h1 align="center">RESIDENCE ACADEMIC SUPPORT TEAM</h1>
											<div class="row">

												<?php


												$news = "SELECT * FROM Student WHERE position= 'mentor' OR position= 'rc'";
												...
												?>
													 <td>
                                     				    ...
                                     				    <label>Delete</label>
                                     					<a href="deleteStr.php?id=<?php echo $row['stdNum'];?>"> 
