	...
	?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3 align="center"><i class="fa fa"></i> FEMALE RESIDENCE</h3>
				<div class="row">    
                  <div class="col-md-12">
        ...
        <thead>
		<th colspan=3></th>
		  <th colspan=6>Female Residence</th>
            <tr>
                                 <th>Sno.</th>
		...
		<?php
                              ...
                              $ret=mysqli_query($con,"select * from Residence WHERE date LIKE '%$search%' OR status LIKE '%$search%' OR roomNum LIKE '%$search%' OR stdNum LIKE '%$search%' ");
                              ...
                              echo'<td>'.$cnt.'</td>';
                                  ...
                                  echo'<td>';
                                    ...
                                    /* echo '<a href="updateRes.php?ustd='.$row['stdNum'].'"> ';
                                     ...
                                     echo'<a href="deleteFemale.php?stdNum='.$row['stdNum'].'">';
                                     ?>
                              ...
                              {
                                $ret=mysqli_query($con,"select * from Residence WHERE gender ='female'  ");
