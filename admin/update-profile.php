...
$date= $_POST['date'];
	...
	{
	    	mysqli_query($con,"UPDATE Student SET stdNum='$stdNum', email='$email', contactno='$contact', posting_date ='$date' where email='".$_GET['uid']."'");
                  ...
                  <div class="col-md-12">
                      ...
                      <p align="center" style="color:#F00;"><?php echo $_SESSION['msg'];?><?php echo $_SESSION['msg']=""; ?></p>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="tell" class="form-control" name="contact" pattern = "(\+27|0)[6-8][0-9]{8}" title="Must be a south African Number starting with a zero(0)" value="<?php echo $row['contactno'];?>" minlenght="10" maxlength="10" >
                              </div>
                          </div>
                            <div class="form-group">
