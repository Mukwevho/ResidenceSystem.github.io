...
<html lang="en">
  <head>
    ...
    <title>Manage Users</title><!-----------change title>
...
<!------------------------------------------------------------->
      ...
      <section id="main-content">
        ...
        <tbody>
		<?php 
									 		  $ret=mysqli_query($con,"select * from Student u,StudentRecord s where u.stdNum=s.stdNum");
											  $cnt=1;
            ...
            <tr>
				...
				<td><a href="update-profile.php?uid=<?php echo $row['email'];?>">Edit</a> |
				<!--<button class="btn btn-danger btn-xs" onClick= "return confirm('Do you really want to delete');"> <i class="fa fa-trash-o "></i></button>-->
				<a href="deleteUser.php?id=<?php echo $row['email'];?>" onClick= "return confirm('Do you really want to delete');">Delete
			     </a>
                 </td>
            </tr>
            <?php } ?>
